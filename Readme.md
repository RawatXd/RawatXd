...
* **Machine Learning:** Scikit-Learn, XGBoost, Classification, Feature Engineering, Model Evaluation
* **Operations Research:** Linear Programming, Integer Programming, Monte Carlo Simulation, Optimization Modeling, Decision Analysis
* **Tools & Platforms:** Power BI, Streamlit, Jupyter Notebook, VS Code, Git, GitHub
* **Databases:** PostgreSQL, MySQL
* **Domain Expertise:** Operational Research, Data Science, Predictive Analytics, Decision Support Systems
